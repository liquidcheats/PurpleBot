...
library.theme = {
    ...
    backgroundcolor = Color3.fromRGB(35, 35, 35), -- BackgroundColor from hexadecimal
    tabstextcolor = Color3.fromRGB(255, 255, 255), -- FontColor from hexadecimal
    bordercolor = Color3.fromRGB(126, 72, 163), -- AccentColor from hexadecimal
    accentcolor = Color3.fromRGB(126, 72, 163), -- AccentColor from hexadecimal
    accentcolor2 = Color3.fromRGB(126, 72, 163), -- AccentColor from hexadecimal
    outlinecolor = Color3.fromRGB(30, 30, 30), -- MainColor from hexadecimal
    outlinecolor2 = Color3.fromRGB(12, 12, 12), -- Custom color
    sectorcolor = Color3.fromRGB(30, 30, 30), -- MainColor from hexadecimal
    toptextcolor = Color3.fromRGB(200, 200, 200), -- Custom color
    topheight = 48,
    topcolor = Color3.fromRGB(28, 28, 28), -- Custom color
    topcolor2 = Color3.fromRGB(38, 38, 38), -- Custom color
    buttoncolor = Color3.fromRGB(50, 50, 50), -- Custom color
    buttoncolor2 = Color3.fromRGB(40, 40, 40), -- Custom color
    itemscolor = Color3.fromRGB(255, 255, 255), -- FontColor from hexadecimal
    itemscolor2 = Color3.fromRGB(255, 255, 255) -- FontColor from hexadecimal
}
