...
library.theme = {
    ...
    tabstextcolor = Color3.fromRGB(200, 200, 200), -- Light text color (keeps good contrast)
    ...
    topheight = 48,
    topcolor = Color3.fromRGB(85, 84, 82), -- Soft gray for the top bar background
    ...
    itemscolor = Color3.fromRGB(89, 67, 113), -- Deeper, bluish tone for items
    itemscolor2 = Color3.fromRGB(85, 84, 82) -- Soft, gray tone for secondary items color
}
