...
library.theme = {
    ...
    tabstextcolor = Color3.fromRGB(200, 200, 200), -- Light text color for contrast
    bordercolor = Color3.fromRGB(30, 30, 30), -- Soft, gray tone for borders
    accentcolor = Color3.fromRGB(89, 67, 113), -- Dark purple blush accent color
    accentcolor2 = Color3.fromRGB(89, 67, 113), -- Dark secondary accent color
    outlinecolor = Color3.fromRGB(30, 30, 30), -- Very dark background outline
    outlinecolor2 = Color3.fromRGB(17, 18, 22), -- Slightly lighter outline
    ...
    topheight = 48,
    topcolor = Color3.fromRGB(21, 21, 21), -- Soft gray for the top bar background
    topcolor2 = Color3.fromRGB(17, 18, 22), -- Slightly lighter top bar background
    buttoncolor = Color3.fromRGB(50, 50, 50), -- Dark button color
    buttoncolor2 = Color3.fromRGB(40, 40, 40), -- Slightly lighter button color
    itemscolor = Color3.fromRGB(200, 200, 200), -- Dark purple blush items color
    itemscolor2 = Color3.fromRGB(200, 200, 200) -- Soft, gray tone for secondary items color
}
