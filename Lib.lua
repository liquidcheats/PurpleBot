...
library.theme = {
    ...
    backgroundcolor = Color3.fromRGB(17, 18, 22), -- Very dark blue-gray background
    tabstextcolor = Color3.fromRGB(177, 177, 177), -- Light text color (keeps good contrast)
    bordercolor = Color3.fromRGB(89, 67, 113), -- Soft, gray tone for borders
    accentcolor = Color3.fromRGB(17, 18, 22), -- Deeper, bluish tone for accents
    accentcolor2 = Color3.fromRGB(17, 18, 22), -- Dark secondary accent color
    outlinecolor = Color3.fromRGB(89, 67, 113), -- Very dark background outline
    outlinecolor2 = Color3.fromRGB(85, 84, 82), -- Slightly lighter outline
    sectorcolor = Color3.fromRGB(17, 18, 22), -- Dark sector color
    toptextcolor = Color3.fromRGB(177, 177, 177), -- Light text color for top bar
    topheight = 48,
    topcolor = Color3.fromRGB(17, 18, 22), -- Soft gray for the top bar background
    topcolor2 = Color3.fromRGB(85, 84, 82), -- Slightly lighter top bar background
    buttoncolor = Color3.fromRGB(17, 18, 22), -- Dark button color
    buttoncolor2 = Color3.fromRGB(85, 84, 82), -- Slightly lighter button color
    itemscolor = Color3.fromRGB(177, 177, 177), -- Deeper, bluish tone for items
    itemscolor2 = Color3.fromRGB(185, 185, 185) -- Soft, gray tone for secondary items color
}
