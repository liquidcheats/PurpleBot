...
library.theme = {
    ...
    bordercolor = Color3.fromRGB(126, 72, 163),
    accentcolor = Color3.fromRGB(126, 72, 163),
    accentcolor2 = Color3.fromRGB(126, 72, 163),
    outlinecolor = Color3.fromRGB(126, 72, 163),
    outlinecolor2 = Color3.fromRGB(126, 72, 163),
    sectorcolor = Color3.fromRGB(30, 30, 30),
    toptextcolor = Color3.fromRGB(200, 200, 200),
    topheight = 48,
    topcolor = Color3.fromRGB(28, 28, 28),
    topcolor2 = Color3.fromRGB(38, 38, 38),
